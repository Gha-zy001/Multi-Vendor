...
<section class="welcome_area">
  <div class="welcome_slides owl-carousel">
      <!-- Single Slide -->
      <div class="single_slide bg-img" style="background-image: url('{{asset('frontend/user-interface/img/bg-img/8.jpg')}}')';">
              ...
              <div class="row h-100 align-items-center">
                  ...
                  <div class="col-5 col-md-4">
                      <div class="welcome_slide_image">
                          <img src="{{asset('frontend/user-interface/img/bg-img/slide-1.png')}}" alt="" data-animation="bounceInUp" data-delay="500ms">
      ...
      <div class="row">
          ...
          <div class="col-12 col-md-4">
              <div class="single_catagory_area mt-50">
                  <a href="#">
                      <img src="{{asset('frontend/user-interface/img/bg-img/c1.jpg')}}" alt="">
                  </a>
              </div>
          </div>
          ...
          <div class="col-12 col-md-4">
              <div class="single_catagory_area mt-50">
                  <a href="#">
                      <img src="{{asset('frontend/user-interface/img/bg-img/c2.jpg')}}" alt="">
                  </a>
              </div>
          </div>
          ...
          <div class="col-12 col-md-4">
              <div class="single_catagory_area mt-50">
                  <a href="#">
                      <img src="{{asset('frontend/user-interface/img/bg-img/c3.jpg')}}" alt="">
                  </a>
              </div>
          </div>
      </div>
                          ...
                          <div class="top_sellers_area">
                              <div class="row">
                                  <div class="col-12 col-sm-6 col-lg-4">
                                      <div class="single_top_sellers">
                                          <div class="top_seller_image">
                                              <img src="{{asset('frontend/user-interface/img/product-img/top-1.png')}}" alt="Top-Sellers">
                                          </div>
                                  ...
                                  <div class="col-12 col-sm-6 col-lg-4">
                                      <div class="single_top_sellers">
                                          <div class="top_seller_image">
                                              <img src="{{asset('frontend/user-interface/img/product-img/top-2.png')}}" alt="Top-Sellers">
                                          </div>
                                          <div class="top_seller_desc">
                                              <h5>Beach Cap</h5>
